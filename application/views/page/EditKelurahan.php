			...
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-lg-6">
					<div class="card card-success">
						...
						<div class="card-body">
							<form action="<?php echo site_url('Master/updateKelurahanAction') ?>" method="post" enctype="multipart/form-data">
								<div class="col-lg-12">
									...
									<div class="form-group">
										...
										<select class="form-control" id="kecamatan" name="kode_kecamatan">
											...
											<?php foreach($kecamatan as $row) { ?>
												<?php if ($kl->kode_kecamatan == $row->kode_kecamatan) { ?>
									...
									<div class="form-group">
										...
										<input type="text" name="kode_kelurahan" class="form-control" placeholder="Kode Kelurahan" value="<?= $this->input->post('kode_kelurahan') ?? $kl->kode_kelurahan ?>">
										<?= form_error('kode_kelurahan','<small class="text-danger">','</small>') ?>
									</div>
									<div class="form-group">
										<label>Nama Kelurahan</label>
										<input type="text" name="nama_kelurahan" class="form-control" placeholder="Nama Kelurahan" value="<?= $this->input->post('nama_kelurahan') ?? $kl->nama_kelurahan ?>">
