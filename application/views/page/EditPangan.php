			...
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-lg-6">
					<div class="card card-success">
						...
						<div class="card-body">
							<form action="<?php echo base_url() ?>Master/updatePanganAction" method="post" enctype="multipart/form-data">
								<div class="col-lg-12">
									...
									<div class="form-group">
										<label>Kode</label>
										<input type="text" name="kode" class="form-control" placeholder="Kode" value="<?= $this->input->post('kode') ?? $pgn->kode ?>">
										<?= form_error('kode','<small class="text-danger">','</small>') ?>
									</div>
									<div class="form-group">
										<label>Jenis Pangan</label>
										<input type="text" name="jenis" class="form-control" placeholder="Jenis Kemasan" value="<?= $this->input->post('jenis') ?? $pgn->jenis ?>">
