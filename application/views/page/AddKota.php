			...
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-lg-6">
					<div class="card card-success">
						...
						<div class="card-body">
							<form action="<?php echo site_url('Master/addKotaAction') ?>" method="post" enctype="multipart/form-data">
								<div class="col-lg-12">
									<input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" 
									value="<?= $this->security->get_csrf_hash() ?>">
									<div class="form-group">
										<label>Kode Kota</label>
										<input type="text" name="kode_kota" class="form-control" placeholder="Kode Kota" value="<?= set_value('kode_kota') ?>">
										<?= form_error('kode_kota','<small class="text-danger">','</small>') ?>
									</div>
									<div class="form-group">
										<label>Nama Kota</label>
										<input type="text" name="nama_kota" class="form-control" placeholder="Nama Kota" value="<?= set_value('nama_kota') ?>">
