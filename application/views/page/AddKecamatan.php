			...
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-lg-6">
					<div class="card card-success">
						...
						<div class="card-body">
							<form action="<?php echo site_url('Master/addKecamatanAction') ?>" method="post" enctype="multipart/form-data">
								<div class="col-lg-12">
									...
									<div class="form-group">
										...
										<select class="form-control" id="kota" name="kode_kota">
											...
											<?php foreach($kota as $row) { ?>
												<option value="<?=$row->kode_kota;?>" <?= set_select('kode_kota',$row->kode_kota ) ?>><?=$row->nama_kota;?></option>
											<?php } ?>
										</select>
									...
									<div class="form-group">
										...
										<input type="text" name="kode_kecamatan" class="form-control" placeholder="Kode Kecamatan" value="<?= set_value('kode_kecamatan') ?>">
										<?= form_error('kode_kecamatan','<small class="text-danger">','</small>') ?>
									</div>
									<div class="form-group">
										<label>Nama Kecamatan</label>
										<input type="text" name="nama_kecamatan" class="form-control" placeholder="Nama Kecamatan" value="<?= set_value('nama_kecamatan') ?>">
